 ...
 *
 * Copied from dojox.uuid.generateRandomUuid,
 * as the latter depends on its './_base' package which is useless
 * and requires the global 'dojo' (which prevent us to set
 * prevent extend-dojo=0 in has() definitions.
 */
define([], function(){
